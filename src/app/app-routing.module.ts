...
const myAdsRoutes: Routes = [
  ...
  {path: 'published', component: AdsModerationComponent},
...
const accountRoutes: Routes = [
  ...
  {path: 'my_page', component: ClientPageComponent, children: myAdsRoutes},
  {path: 'admin_chat', component: AdminChatComponent},
];

const appRoutes: Routes = [
  { path: '', redirectTo: '/ads', pathMatch: 'full' },
  { path: 'client', children: accountRoutes },
